...
const [isReaderDropdownOpen, setIsReaderDropdownOpen] = useState(false);
  ...
  return (
    ...
    <li><Link className="hover:text-gray-400 font-bold mr-8px" to="/catalogo">Nome-Biblioteca </Link></li>              
   ...
   {/* Área do leitor dropdown */}
    <div className="flex items-center space-x-6">
        ...
        <div className="relative">
          <button
            className="px-4 py-2 hover:text-gray-900 font-bold flex items-center"
          ...
          {isReaderDropdownOpen && (
            ...
            >
              <div className="py-1">
                <Link className="block px-4 py-2 text-sm text-white font-bold hover:bg-gray-700" to="/login"
                >
                  Fazer login
                </Link>
                <Link to="/criar-conta"
